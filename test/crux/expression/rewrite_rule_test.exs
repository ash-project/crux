...
defmodule Crux.Expression.RewriteRuleTest do
  ...
  alias Crux.Expression.RewriteRule.DeMorgansLaw
  alias Crux.Expression.RewriteRule.DistributiveLaw
  alias Crux.Expression.RewriteRule.NegationLaw
